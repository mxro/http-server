...
import nx.restserver.netty.ResourceProvider;
...
public class ClassResourceProvider implements ResourceProvider {
	...
	public Resource getResource(final String path) {
		...
		final InputStream resourceAsStream = resourceRoot
				.getResourceAsStream(
						path.replaceFirst(serverRoot, resourcesRoot));
	...
	public ClassResourceProvider(final Class<?> resourceRoot,
			final String serverRoot, final String resourcesRoot) {
		super();
